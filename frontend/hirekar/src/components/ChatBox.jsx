...
const ENDPOINT = "http://16.171.195.37";
...
const ChatBox = () => {
    ...
    const fetchMessages = async () => {
      try {
        const response = await fetch(
          `http://16.171.195.37/api/chat/messages/${chat_id}`,
          {
            headers: {
  ...
  useEffect(() => {
    const fetchChatDetails = async () => {
      try {
        const response = await fetch(
          `http://16.171.195.37/api/chat/${chat_id}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://16.171.195.37/api/chat/message/", {
        method: "POST",
        headers: {
  ...
  const handleBlock = async () => {
    try {
      const response = await fetch(
        `http://16.171.195.37/api/chat/block/${chat_id}`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleUnblock = async () => {
    try {
      const response = await fetch(
        `http://16.171.195.37/api/chat/unblock/${chat_id}`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
