...
const Resume = () => {
  ...
  return (
    <div className="w-full p-4 pt-4 pb-12 pl-8 pr-8">
      ...
      <p className="text-sm mb-4">Let's get to know you, please fill out some basic information about yourself.</p>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <h3 className="font-semibold mb-3 mt-5">Enter Your Personal Information</h3>
        ...
        <div>
          <h3 className=" font-semibold mb-3 mt-5">Enter Your Work Experience</h3>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <input
                type="text"
